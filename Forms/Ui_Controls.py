...
class Ui_Controls(object):
    def setupUi(self, Controls):
        ...
        self.groupBoxDisplay.setEnabled(True)
...
"")
        ...
        self.groupBoxDisplay.setAlignment(QtCore.Qt.AlignCenter)
        self.groupBoxDisplay.setFlat(False)
...
"border: 1px solid rgba(255,255,255,100);")
        ...
        self.groupBoxMeasurements.setStyleSheet("")
        self.groupBoxMeasurements.setTitle("")
        self.groupBoxMeasurements.setAlignment(QtCore.Qt.AlignCenter)
        self.groupBoxMeasurements.setFlat(False)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.labelDeltaT)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.labelDeltaTDisplay)
        ...
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.labelTInverse)
        ...
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.labelTInverseDisplay)
        self.labeltperDiv = QtWidgets.QLabel(self.groupBoxTime)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labeltperDiv.sizePolicy().hasHeightForWidth())
        self.labeltperDiv.setSizePolicy(sizePolicy)
        self.labeltperDiv.setStyleSheet("color: rgb(0, 255, 255);")
        self.labeltperDiv.setObjectName("labeltperDiv")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.labeltperDiv)
        self.labelTperDivDisplay = QtWidgets.QLabel(self.groupBoxTime)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labelTperDivDisplay.sizePolicy().hasHeightForWidth())
        self.labelTperDivDisplay.setSizePolicy(sizePolicy)
        self.labelTperDivDisplay.setStyleSheet("color: rgb(0, 255, 255);")
        self.labelTperDivDisplay.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.labelTperDivDisplay.setObjectName("labelTperDivDisplay")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.labelTperDivDisplay)
        ...
        self.labelVperDiv = QtWidgets.QLabel(self.groupBoxVoltage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labelVperDiv.sizePolicy().hasHeightForWidth())
        self.labelVperDiv.setSizePolicy(sizePolicy)
        self.labelVperDiv.setStyleSheet("color: rgb(0, 255, 255);")
        self.labelVperDiv.setObjectName("labelVperDiv")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.labelVperDiv)
        self.labelVperDivDisplay = QtWidgets.QLabel(self.groupBoxVoltage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labelVperDivDisplay.sizePolicy().hasHeightForWidth())
        self.labelVperDivDisplay.setSizePolicy(sizePolicy)
        self.labelVperDivDisplay.setStyleSheet("color: rgb(0, 255, 255);")
        self.labelVperDivDisplay.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.labelVperDivDisplay.setObjectName("labelVperDivDisplay")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.labelVperDivDisplay)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.labelVpp)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labelVRMS.sizePolicy().hasHeightForWidth())
        self.labelVRMS.setSizePolicy(sizePolicy)
        ...
        self.labelVRMSAC = QtWidgets.QLabel(self.groupBoxVoltage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labelVRMSAC.sizePolicy().hasHeightForWidth())
        self.labelVRMSAC.setSizePolicy(sizePolicy)
        self.labelVRMSAC.setStyleSheet("color: rgb(0, 255, 255);")
        self.labelVRMSAC.setObjectName("labelVRMSAC")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.labelVRMSAC)
        self.labelVRMSAC_Display = QtWidgets.QLabel(self.groupBoxVoltage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labelVRMSAC_Display.sizePolicy().hasHeightForWidth())
        self.labelVRMSAC_Display.setSizePolicy(sizePolicy)
        self.labelVRMSAC_Display.setStyleSheet("color: rgb(0, 255, 255);")
        self.labelVRMSAC_Display.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.labelVRMSAC_Display.setObjectName("labelVRMSAC_Display")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.labelVRMSAC_Display)
        ...
        self.groupBoxSettings.setStyleSheet("")
        self.groupBoxSettings.setFlat(False)
        ...
        self.gridLayout_5.addWidget(self.checkBoxSingleShot, 4, 0, 1, 1)
        self.checkBoxPersist = QtWidgets.QCheckBox(self.groupBoxView)
        self.checkBoxPersist.setObjectName("checkBoxPersist")
        self.gridLayout_5.addWidget(self.checkBoxPersist, 3, 0, 1, 1)
        ...
        self.layoutControls.addWidget(self.groupBoxStorage, 2, 0, 1, 1)
        ...
        self.layoutControls.addWidget(self.dockWidgetCalibration, 4, 0, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(20, 0, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.layoutControls.addItem(spacerItem1, 5, 0, 1, 1)
        ...
        self.layoutScope.addItem(spacerItem2, 1, 3, 1, 1)
    ...
    def retranslateUi(self, Controls):
        ...
        self.labelTInverse.setText(_translate("Controls", "F"))
        self.labelTInverseDisplay.setText(_translate("Controls", "0"))
        self.labeltperDiv.setText(_translate("Controls", "T/Div"))
        self.labelTperDivDisplay.setText(_translate("Controls", "0"))
        self.labelVperDiv.setText(_translate("Controls", "V/Div"))
        ...
        self.labelVRMSAC.setText(_translate("Controls", "VRMS(AC)"))
        self.labelVRMSAC_Display.setText(_translate("Controls", "-"))
        ...
        self.checkBoxPersist.setText(_translate("Controls", "Persist"))
